...
void main() => runApp(
  MaterialApp(
    ...
    home: HomePage(),
    theme: ThemeData(
      primaryColor: Constants.sitWithMeGrey,
      accentColor: Constants.sitWithMeGrey,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        elevation: 5,
          selectedItemColor: Constants.sitWithMeGrey,
        ...
        items:[
          BottomNavigationBarItem(
              ...
              title: Text("NEARBY",style: TextStyle(fontSize: 11),),
          ),
          BottomNavigationBarItem(
              icon: Icon(
              ...
              title: Text("LIKED",style: TextStyle(fontSize: 11),),
          ),
          BottomNavigationBarItem(
            icon: Icon(
