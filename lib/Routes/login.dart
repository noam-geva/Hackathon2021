          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("Welcome To Sit With Me",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),),
                SizedBox(height: 25,),
                Visibility(
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.person_outline,color: Constants.sitWithMeGrey,)
                      ),
                    ),
                  ),
                ),
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                          ...
                          border: InputBorder.none,
                          hintStyle: TextStyle(color: Colors.grey),
                          prefixIcon: Icon(Icons.smartphone,color: Constants.sitWithMeGrey,)
                      ),
                    ),
                  ),
                ),
                Container(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      border: InputBorder.none,
                      hintStyle: TextStyle(color: Colors.grey),
                      prefixIcon: Icon(Icons.mail_outline,color: Constants.sitWithMeGrey,),
                    ),
                  ),
                ),
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        border: InputBorder.none,
                        hintStyle: TextStyle(color: Colors.grey),
                        prefixIcon: Icon(Icons.lock_outline,color: Constants.sitWithMeGrey,),
                    ),
                  ),
                ),
                Visibility(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                        ...
                        child: Text("Forgot password ?",style: TextStyle(color: Constants.sitWithMeGrey,fontSize: 12),)),
                  ),
                ),
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  ...
                                  style: TextStyle(color: Constants.sitWithMeGrey,fontWeight: FontWeight.w600, fontSize: 14),)
                              ]),
                        ),
                      ),
                    ),
