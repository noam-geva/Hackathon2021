...
class Properties extends StatefulWidget {
  final absrtrucSpaceForFutureDataBase spaces;
  Properties({this.spaces});
  @override
          ...
          Stack(
            children: <Widget>[
              Container(
                ...
                child:Hero(
                  tag: widget.spaces.image,
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(30),
                      child:Image(image: AssetImage(widget.spaces.image),
                        fit: BoxFit.cover,),
                    )
                )
              ),
              ...
              Positioned(
                ...
                child:Column(
                  ...
                  children: <Widget>[
                    Text("${widget.spaces.name}",style: TextStyle(
                        fontSize: 35,
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        SizedBox(width:8,),
                        Text("${widget.spaces.id}",style: TextStyle(
          ...
          Expanded(
            child: GestureDetector(
              onTap:(){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PropertyDetails(Constants.spaces[0])),
                );
              },
              child: ListView.builder(
                  padding : EdgeInsets.only(top:10,bottom: 15),
                  itemCount : Constants.spaces.length
                  ,itemBuilder: (BuildContext context,int index){
                WorkSpace property = Constants.spaces[index];
                return Stack(
                  children: <Widget>[
                    Container(
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                Container(
                                  width:120,
                                  child: Text(property.title,style: TextStyle(fontWeight: FontWeight.w600,
                                      fontSize: 18
                                  ),
                                    maxLines: 2,
                            ...
                            _buildRaitingStars(property.rating),
                            SizedBox(height: 10,),
