import 'package:airbnb_clone/Routes/AddProperty/name.dart';
        ...
        child: Padding(
           padding: EdgeInsets.symmetric(vertical:25,horizontal: 25 ),
            ...
            Navigator.pop(context);
               ...
               SizedBox(height: 20,),
                Text("Photos help workers and students to imagine themselves in your workspace. You can start with a photo and add more after posting",style: TextStyle(fontSize: 18,color:Colors.black87,fontWeight: FontWeight.w400),),
               SizedBox(height: 30,),
                MaterialButton(
                  onPressed: (){
                    /*Navigator.push(
