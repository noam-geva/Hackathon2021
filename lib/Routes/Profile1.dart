                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          item(Constants.spaces[0]),
                          item(Constants.spaces[1]),
                          item(Constants.spaces[2]),
                        ],
                      ),
                    )
                  ],
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              Text("Reservations Made",style: textStyleState,),
          ...
          Column(
            children: <Widget>[
              ...
              Text("Reservations",style: textStyleState,),
              Text("\u007c",style: textStyle2,),
            ],
          ),
          Column(
            children: <Widget>[
              ...
              Text("local",style: textStyleState,),
              Text("\u007c",style: textStyle2,),
            ],
          ),
        ],
      ...
      child: Row(
        children: <Widget>[
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Text("first name last name",style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 24,
                color: Colors.white
              ),),
              SizedBox(height: 5.0,),
              Text("a little description",style: textStyle2,)
            ],
          )
        ],
      ),
