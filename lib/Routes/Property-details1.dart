                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text(widget._property.title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
                          ),
                          Padding(
                          ...
                          Padding(
                            padding:  EdgeInsets.symmetric(horizontal: 24),
                            child: Text("${widget._property.description}",
    ...
    return Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text("${widget._property.price}",style: TextStyle(color: Colors.white),),
              Text("/ hh",style: TextStyle(color: Colors.white,fontSize: 16),),
            ],
          ),
        );
  }
