...
import 'package:airbnb_clone/Routes/AddProperty/editNewWorkSpace.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("2 Ads",style: TextStyle(color:Colors.black87,fontSize: 22,fontWeight: FontWeight.bold),),
                      ...
                      children: <Widget>[
                        Container(
                          height:80,
                            ...
                            child: Center(child: Text("WorkSpace in Jerusalem",style: TextStyle(fontSize:15,fontWeight: FontWeight.w300),
                        ...
                        Container(
                          ...
                          height: 80,
                          child: Image(
                            image: AssetImage("assets/images/macbook_w_logo.png"),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                            height:80,
                            width: MediaQuery.of(context).size.width/2,
                            child: Center(child: Text("Private Workspace in Tel Aviv",style: TextStyle(fontSize:15,fontWeight: FontWeight.w300),maxLines: 5,textAlign: TextAlign.center,))),
                        Container(
                            padding:EdgeInsets.all(8),
                            margin: EdgeInsets.only(left: 8),
                            height: 80,
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              child: Text("Create another Ad",style: TextStyle(fontWeight: FontWeight.w500),))
                        ],
                      ),
                    ),
                  ),
