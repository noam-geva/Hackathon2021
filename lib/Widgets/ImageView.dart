    ...
    return Container(
        ...
        child:GestureDetector(
          child:Container(
            ...
            child: Icon(!widget._liked?Icons.favorite_border:Icons.favorite,color:!widget._liked? Colors.black:Constants.sitWithMeRed,size: 25,),
          ),
          onTap: (){
            setState(() {
            ...
            Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  buildWidgetImageIndicator(context,Constants.spaces[1],widget._currentIndex),
                  ...
                  Column(
                    children: [
                      Align(
                        ...
                        child:  Text(widget.property.title,style: TextStyle(color: Colors.black87,fontSize: 15,fontWeight: FontWeight.w400),),
                      ),
                      Align(
                        alignment: Alignment.topLeft,
                        child:  Text(widget.property.address.city,style: TextStyle(color: Colors.black87,fontSize: 18,fontWeight: FontWeight.w400),overflow: TextOverflow.ellipsis,),
                      ),
                      Align(
                        alignment: Alignment.topLeft,
                        child:  Text(widget.property.title,style: TextStyle(color: Colors.black87,fontSize: 18,fontWeight: FontWeight.w400),overflow: TextOverflow.ellipsis,),
                      ),
                      Align(
                        alignment: Alignment.topLeft,
                        child:  Text("${widget.property.price} NIS/hour",style: TextStyle(color: Colors.black54,fontSize: 13,fontWeight: FontWeight.w400),),
                      ),
                      Row(
                        children: <Widget>[
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child:  Text("${widget.property.rating}",style: TextStyle(color: Colors.black87,fontSize: 13,fontWeight: FontWeight.w400),overflow: TextOverflow.ellipsis,),
                          ) ,
                          Align(
                            alignment: Alignment.topLeft,
