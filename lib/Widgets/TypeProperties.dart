      ...
      children: <Widget>[
        Padding(
            ...
            child:Row(
              ...
              children: <Widget>[
                Text("Top spaces",style: TextStyle(fontSize: 22,
        ...
        Container(
          height: 300,
          child: ListView.builder(itemCount: Constants.spaces.length,
            scrollDirection: Axis.horizontal,
            itemBuilder: (BuildContext context,int index){
            absrtrucSpaceForFutureDataBase wilaya =Constants.extraSpaces[index];

              return GestureDetector(
                onTap: ()=> {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => Properties(spaces: wilaya)))
                },
                child: Container(
                  width: 210,
                          ...
                          children: <Widget>[
                            ...
                            Positioned(
                              ...
                              child:Column(
                                crossAxisAlignment: CrossAxisAlignment.start  ,
                                children: <Widget>[
                                  Text("${wilaya.name}",style: TextStyle(
                                      fontSize: 26,
                                      fontWeight: FontWeight.w600,
                                      color: Colors.white,
                                      letterSpacing: 1.2
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      SizedBox(width:8,),
                                      Text("${wilaya.id}",style: TextStyle(
                                        color: Colors.white,
                                      ),)
                                    ],
                                  )
